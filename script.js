...
const translations = {
  ...
  "national 10 km cells": "خلية وطنية 10 كم",
  "high-resolution 1 km cells": "خلية عالية الدقة 1 كم",
  "service categories": "فئة خدمية",
  "Dashboard": "داشبورد",
  "+ Arabic report": "+ تقرير عربي",
  "Built a national spatial service atlas for Iraq using grid-based analysis instead of only governorate-level summaries.": "بناء أطلس مكاني وطني لخدمات العراق باستخدام تحليل شبكي بدلاً من الاكتفاء بملخصات على مستوى المحافظات.",
  "Classified service points into 16 major service categories for comparable spatial analysis.": "تصنيف نقاط الخدمة إلى 16 فئة خدمية رئيسية لإتاحة تحليل مكاني قابل للمقارنة.",
  "Created 10x10 km national grid analysis and 1x1 km governorate-level exploration.": "إنشاء تحليل وطني بشبكات 10x10 كم واستكشاف عالي الدقة 1x1 كم على مستوى المحافظات.",
  "Designed an interactive dashboard for filtering by governorate, district, grid resolution, indicator, and service category.": "تصميم داشبورد تفاعلي للتصفية حسب المحافظة والقضاء ودقة الشبكة والمؤشر والفئة الخدمية.",
  "Added indicators for total services, services per population, services per built-up area, spatial specialization, and potential service-appearance gaps.": "إضافة مؤشرات لإجمالي الخدمات، والخدمات نسبة إلى السكان، والخدمات نسبة إلى المساحة المبنية، والتخصص المكاني، والفجوات المحتملة في ظهور الخدمات.",
  "Produced an Arabic analytical report summarizing the strongest insights and explaining why grid-level analysis reveals patterns hidden by governorate averages.": "إنتاج تقرير تحليلي عربي يلخص أقوى النتائج ويوضح لماذا يكشف التحليل الشبكي أنماطاً تخفيها متوسطات المحافظات.",
  "View Dashboard": "عرض الداشبورد",
